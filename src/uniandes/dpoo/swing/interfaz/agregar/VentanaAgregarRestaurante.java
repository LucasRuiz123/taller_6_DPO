...

{
    ...
    public void agregarRestaurante( )
    {
        ...
        // Obtener ubicación del panel del mapa
        // (Asumiendo que PanelMapaAgregar tiene un método getUbicacion())
        int[] coordinadas  = panelMapa.getCoordenadas();
        
        // Enviar datos a la ventana principal para crear el restaurante
        ventanaPrincipal.agregarRestaurante(nombre, calificacion,coordinadas[0],coordinadas[1], visitado);
